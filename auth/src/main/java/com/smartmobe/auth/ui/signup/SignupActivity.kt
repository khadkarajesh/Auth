...
class SignupActivity : BaseActivity<SignupViewModel>(SignupViewModel::class) {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
                ...
                .forEach {
                    it?.editText?.addTextChangedListener(object : TextWatcher {
                        ...
                        override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                            ...
                            if (signup_til_password.editText?.text.toString()!!
                                    != signup_til_confirm_password.editText?.text.toString()) {
        ...
        signup_btn_submit.setOnClickListener {
            viewModel.signUp(SignupBody(signup_til_username.editText.toString(),
                    signup_til_email.editText.toString(),
                    signup_til_password.editText.toString()))
        }
    }
